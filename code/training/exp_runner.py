...
if __name__ == '__main__':
    ...
    parser.add_argument('--nepoch', type=int, default=20000000, help='number of epochs to train for')
    ...
    parser.add_argument('--collection_id', type=int, default=-1, help='If set, taken to be the scan id.')
